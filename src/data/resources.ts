...
export default [
  ...
  },
  {
    ...
    description:
      "This paper introduces CoverUp, a test generation framework that uses LLMs guided by coverage analysis to produce high-coverage Python regression tests. The core insight is that test generation quality improves significantly when the LLM is prompted iteratively with precisely scoped information, missing coverage, minimal yet sufficient code context (using tool calling) and iterative feedback.",
    tags: [
      "llm",
      "testing",
      "coverage",
  ...
  },
  {
    ...
    description:
      "Brené Brown on the importance of clear communication in relationships and work.",
  ...
  },
  {
    ...
    description:
      "Richard Feynman’s famous 1974 Caltech commencement address on the nature of scientific integrity.",
  ...
  },
  {
    ...
    description:
      "This post explains how Rust symbols are resolved and how the linker works in Rust.",
  ...
  },
  {
    ...
    description:
      "Type Freezing optimisation technique in Tracing JIT Compilers.",
    tags: [
      "jit",
      "optimisation",
      "compilers",
  ...
  },
  {
    ...
    description:
      "Application of Tracing JIT Compilers in the context of the PyPy project.",
  ...
  },
  {
    ...
    description:
      "This blog post lists some popular git config options that I found useful.",
  ...
  },
  {
    ...
    description:
      "Integers types and memmory layout on different architectures and runtimes",
  ...
  },
  {
    ...
    description:
      "post about measuring the size of the cache line empirically on different artchitectures",
  ...
  },
  {
    ...
    description:
      "An article about Postgres Concurrency model and Multi Version Concurrency Control mechanism",
  ...
  },
  {
    ...
    title: "BFS 3.0",
    description:
      "bfs is a tool written to do breadth-first search through a filesystem",
  ...
  },
  {
    ...
    description:
      "Alice Rhyl (one of the Tokio devs) blog post on blocking in async code.",
  ...
  },
  {
    ...
    description:
      "Academic paper on redundant loads profiling and optimisations with LOADSPY",
    tags: [
      "perf",
      "ebpf",
      "bcc",
  ...
  },
  {
    ...
    title: "Stack frame layout on x86-64",
    description:
      "Article about the stack frame layout of the newer 64-bit version of the x86 architecture, x64.",
  ...
  },
  {
    ...
    title:
      "How we built Shadow Indexing, the subsystem powering Redpanda’s tiered storage capabilities",
    description:
  ...
  },
  {
    ...
    description:
      "The web of American Transcendentalism, collection of resources and links",
  ...
  },
  {
    ...
    description:
      "Hexagonal Architecture is a fabulous pattern to easily embrace changes within our projects.",
