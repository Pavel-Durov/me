...
export default [
  {
    ...
    description: 'This paper presents findings on the performance characteristics of interpreters, revealing that they execute a substantial proportion of indirect branches, ranging from 3.2% to 13%. It also suggest on how to improve the performance of interpreters.',
  ...
  },
  {
    ...
    description: 'This paper presents an idea to generate threaded code by reusing an existing meta-tracing JIT compiler, as well as an interpreter design for it.',
